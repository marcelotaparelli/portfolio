...
An article by Martin Fowler on [GenAI patterns](https://martinfowler.com/articles/gen-ai-patterns/) describes this kind of mechanism as **scoring and judging**: the model's output goes through a scorer that produces metrics or feedback about the result.
