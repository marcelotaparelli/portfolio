...
Um artigo do Martin Fowler sobre [GenAI patterns](https://martinfowler.com/articles/gen-ai-patterns/) descreve esse tipo de mecanismo como **scoring and judging**: a saída do modelo passa por um scorer que produz métricas ou feedback sobre o resultado.
